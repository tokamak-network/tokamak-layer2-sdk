...
export const CONTRACT_ADDRESSES: {
  ...
  [L2ChainID.TOKAMAK_GOERLI_TESTNET]: {
    l1: {
      AddressManager: '0xEFa07e4263D511fC3a7476772e2392efFb1BDb92' as const,
      L1CrossDomainMessenger:
        '0x2878373BA3Be0Ef2a93Ba5b3F7210D76cb222e63' as const,
      L1StandardBridge: '0x7377F3D0F64d7a54Cf367193eb74a052ff8578FD' as const,
      StateCommitmentChain:
        '0xd52E839b21cE302B15f7652Dc44Cb33841450418' as const,
      CanonicalTransactionChain:
...
export const BRIDGE_ADAPTER_DATA: {
  ...
  //   TON: {
  //     Adapter: DAIBridgeAdapter,
  //     l1Bridge: '0x7377F3D0F64d7a54Cf367193eb74a052ff8578FD' as const,
  //     l2Bridge: '0x4200000000000000000000000000000000000010' as const,
  //   },
  // },
}
